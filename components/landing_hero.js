    ...
    return (
        ...
        <div className="min-h-screen flex">
            ...
            <div className="container mx-auto py-20">
                ...
                <div class="flex flex-col p-5 justify-evenly bg-gray-400 rounded-md bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-20 border border-gray-100 my-5 md:flex-row content-center">
