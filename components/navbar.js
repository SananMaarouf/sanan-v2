        ...
        <nav>
            <div className="navbar bg-neutral text-white bg-transparent">
                ...
                <div className="navbar-end">
                    <a href="https://github.com/SananMaarouf" className="btn text-black bg-zinc-100" target="_blank" rel="noopener noreferrer">GitHub</a>
                    <a href="https://www.linkedin.com/in/sanan-maarouf/" className="btn text-black ml-1 bg-zinc-100" target="_blank" rel="noopener noreferrer">LinkedIn</a>
                </div>
            </div>
        </nav>
