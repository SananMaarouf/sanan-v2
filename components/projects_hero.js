            ...
            >
                <div id='projects' className="min-h-screen flex">
                    <div className="container mx-5 py-20 md:mx-auto">
                        ...
                        <div class="flex flex-col py-4 justify-evenly bg-gray-400 rounded-md bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-20 borderborder-gray-100 my-5 content-center hover:backdrop-blur-lg">
                            <p class="text-4xl font-bold text-white text-center">Projects</p>
                            {/* carousel with card components inside */}
                            <div className='my-5 carousel mx-auto'>
